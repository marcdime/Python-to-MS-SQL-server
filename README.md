...
- SurveyStructure: [SurveyId], [QuestionId], [OrdinalValue] . *This table is the key table that describes the survey structure based on which we can extract the data.* 
